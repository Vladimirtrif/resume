  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Engineering Intern}{Dec 2024 \textbf{--} Present}
        \resumeItemListStart
            \resumeItem{Working as backend engineer intern for cloud security startup. Saas security monitoring for cloud deoployments}
    ...
    \resumeSubheading
      ...
      {Software Engineer}{Sep 2024 \textbf{--} Present}
        \resumeItemListStart
            ...
            \resumeItem{Cross-platform, written in typescript and react }
        \resumeItemListEnd
