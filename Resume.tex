...
\section{Experience}
  ...
  \resumeSubheading
    ...
    {Software Engineering Intern}{Dec 2024 \textbf{--} Feb 2025, Part-Time}
      \resumeItemListStart
          \resumeItem{Working as backend engineering intern for startup focusing on SaaS security monitoring for cloud deployments}
      ...
      \resumeProjectHeading
        {\textbf{Dungeon Raider} $|$ \emph{\href{https://github.com/Vladimirtrif/DungeonRaider}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            ...
            \resumeItem{ Created for FBLA Computer Game and Simulation event. Presented at state level in Washington (WAFBLA)}
      \resumeItemListEnd
